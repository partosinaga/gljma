...
<html lang="en">
    ...
    <body class=" login" style="background-color:#26C281">
        <!-- BEGIN LOGO -->
        <div class="logo">
           <h3 class="font-white"> <?php echo strtoupper( $row->name); ?> </h3>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <form class="login-form" action="<?php echo site_url('home/valid_login') ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input style="background-color:#35a872" class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Username" name="username" /> 
                </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Password</label>
                    <input style="background-color:#35a872" class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" name="password" /> 
                </div>
        ...
        <div class="copyright"> <?php echo date("Y") ?> © PT MONSTERA INTI TEKNOLOGI</div>
        <!-- END LOGIN -->
        <!--[if lt IE 9]>
