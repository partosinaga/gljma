      ...
      <section class="content">
        ...
        <div class="box box-success">
          <div class="box-header with-border" align="center">
            <h3 class="box-title"><i class="fa fa-tag" ></i>  Unposting Journal Voucher</h3>
          </div><br>
  ...
  <div>
    ...
    <h2 align="center"><i class="fa fa-warning"></i></h2>
      ...
      <div class="modal-footer">
          <a href="<?php echo site_url().'/jv/jv/save_unposting?id='.$p->no_voucher ?>"  >
...
function getCheckedValue(){
  ...
  if (check.length <= 1) {
    ...
    $.ajax({
      type : 'POST',
      url : '<?php echo site_url();?>/jv/jv/mass_unposting',
      data : {
        check : check,
        gln: gln
      },
      success: function (msg) {
          console.log(msg);
          location.reload();
          toastr.success('All selected Voucher unposted !');
      },
      complete:function(){
        $("#loading").hide();
      }
