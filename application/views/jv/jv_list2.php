  ...
  <div class="content-wrapper">
    <div class="container">
      ...
      <section class="content-header">
        <h1>
          <small>Journal</small> <small>Voucher (JV)</small>
                           ...
                           <div class="btn-group">
                            <button class="btn red blue-hoki-stripe btn-xs dropdown-toggle" data-toggle="dropdown"><i class="angle-down"></i> Action
                              ...
                              <ul class="dropdown-menu">
                                ...
                                <li>
                                  ...
                                  <?php
                                    ...
                                    if ($ap->total >= 50000000 ) {
                                      $result .= '<a href ="'.site_url('/jv/jv/print_jv_up?id=').$ap->no_voucher.'" target="_blank"  "><i class="fa fa-print"></i> Print
                                        </a>';
                                    }else{
                                       $result .= '<a href ="'.site_url('/jv/jv/print_jv?id=').$ap->no_voucher.'" target="_blank"  "><i class="fa fa-print"></i> Print
                                        </a>';
                                    }
                                    echo $result;
                                  ?>
                                ...
                                ?>
                                <li>
                                  <a href="<?php echo site_url('jv/jv/cancel_jv?id='.$id.'&status='.$ap->status) ?>"><i class="fa fa-remove"></i> Cancel </a>
                                </li>
                                <!-- <li>
