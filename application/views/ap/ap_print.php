...
<div class="top">  
  <table width="100%">
    <tr>
      <td colspan="7" align="center"  style="font-size: 12pt"><b>PAYMENT VOUCHER</b></td> 
    </tr>
  ...
  <table class="table" bordercolor="black" width="100%" border="1">
   ...
   <table width="100%" class="table" bordercolor="black" border="1">
      <tr>
        ...
        <th align="center"><B>APPROVALS</th>
      </tr>
      <tr align="center">
        ...
        <td height="50px" width="30%"><br>
          ________________________<br>HM
        </td>
        <td height="50px" width="30%"> <br>
          ________________________<br>RY
        </td>
      </tr>
    </table>
</div>
